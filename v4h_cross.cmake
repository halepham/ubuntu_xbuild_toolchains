...
# compilers flags
set(ARM_COMPILE_OPTION "-mcpu=cortex-a76 -fstack-protector-strong -ffunction-sections -fdata-sections -Wformat -Wformat-security -Werror=format-security -Wall -Wextra -Wconversion -Wunused -Wuninitialized -Werror -pedantic-errors")
if(NOT CMAKE_CXX_FLAGS MATCHES "-mcpu=cortex-a76")
...
if(CMAKE_SYSROOT)
    ...
    if(NOT CMAKE_EXE_LINKER_FLAGS MATCHES "(^| )-Wl,--gc-sections( |$)")
        set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,--gc-sections")
    endif()

    if(NOT CMAKE_SHARED_LINKER_FLAGS MATCHES "(^| )-Wl,--gc-sections( |$)")
